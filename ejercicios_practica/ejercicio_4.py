...
if numero_1 > numero_2:
    print("{} resulta ser mayor que {}".format(numero_1,numero_2))
else:
    print("{} resulta ser menor que {}".format(numero_1,numero_2))
...
"por que creo que Python lo reconoce como una variable de tipo numerica al ponerlo de esa manera (7) por que como texto (siete) lo interpreta de otra forma"
